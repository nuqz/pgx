...
This repository is fork of [pgx](https://github.com/jackc/pgx) and used by me personally to store useful functions that are not accepted in the official repository.
When release in official repository comes, this repository will be updated too.
...
## github.com/nuqz/pgx/pgmock

pgmock offers the ability to create a server that mocks the PostgreSQL wire protocol. This is used internally to test pgx by purposely inducing unusual errors. pgproto3 and pgmock together provide most of the foundational tooling required to implement a PostgreSQL proxy or MitM (such as for a custom connection pooler).

## Documentation

pgx includes extensive documentation in the godoc format. It is viewable online at [godoc.org](https://godoc.org/github.com/nuqz/pgx).
